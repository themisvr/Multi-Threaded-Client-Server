...
def make_args_parser():
    ...
    parser.add_argument('--countriesFile', default='./countries_file.txt',
                         help='File with country names', metavar='')
    parser.add_argument('--diseasesFile', default='./diseases_file.txt',
                         help='File with disease names', metavar='')
    parser.add_argument('--maxK', default=4, type=int,
                        help='Max k-parameter', metavar='')
    parser.add_argument('--maxRecordID', default=10000, type=int,
                        help='Max RecordID', metavar='')
    parser.add_argument('--startDate', default='01-01-2000',
